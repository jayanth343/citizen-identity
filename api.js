...
app.get('/test-connection', (req, res) => {
  ...
  const tlsCertPath = path.join(__dirname, 'crypto-config', 'peerOrganizations', 'org1.example.com', 'peers', 'peer0.org1.example.com', 'tls', 'ca.crt');
  const tlsCertExists = fs.existsSync(tlsCertPath);
